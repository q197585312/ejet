...
public class LoadingToast extends Toast {
	...
	public static LoadingToast makeText(Context context, CharSequence text,
			int duration) {
		LoadingToast result = new LoadingToast(context);
	...
	public static LoadingToast makeText(Context context, int resId, int duration)
